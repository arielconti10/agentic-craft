...
The June 2026 revision absorbs an independent clean-room research pass that surfaced shipping products our earlier draft missed (Claude Cowork, Gemini Spark, Google Antigravity, the AWS Cloudscape "Thinking" pattern), corrected factual errors about Claude Code's effort levels, and sharpened the field-survey material with primary sources.
