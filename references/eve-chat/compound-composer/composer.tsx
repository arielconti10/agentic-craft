...
//
// Styling rides on the project's shadcn/ui language (`cn`, `Button`). That is
// a design-system dependency, not an agent-framework dependency — shadcn ships
// as source we own, so it travels with the primitive if it's ever extracted.
// ---------------------------------------------------------------------------
